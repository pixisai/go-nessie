...
func (o ReferenceMetadata2) MarshalJSON() ([]byte, error) {
...
func (o ReferenceMetadata2) ToMap() (map[string]interface{}, error) {
...
type NullableReferenceMetadata2 struct {
	value *ReferenceMetadata2
	isSet bool
}

func (v NullableReferenceMetadata2) Get() *ReferenceMetadata2 {
	return v.value
}

func (v *NullableReferenceMetadata2) Set(val *ReferenceMetadata2) {
	v.value = val
	v.isSet = true
}

func (v NullableReferenceMetadata2) IsSet() bool {
	return v.isSet
}

func (v *NullableReferenceMetadata2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReferenceMetadata2(val *ReferenceMetadata2) *NullableReferenceMetadata2 {
	return &NullableReferenceMetadata2{value: val, isSet: true}
}

func (v NullableReferenceMetadata2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReferenceMetadata2) UnmarshalJSON(src []byte) error {
	v.isSet = true
