...
// checks if the CommitMeta2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommitMeta2{}

// CommitMeta2 struct for CommitMeta2
type CommitMeta2 struct {
...
func (o CommitMeta2) MarshalJSON() ([]byte, error) {
...
func (o CommitMeta2) ToMap() (map[string]interface{}, error) {
...
func (o *CommitMeta2) UnmarshalJSON(data []byte) (err error) {
	...
	varCommitMeta2 := _CommitMeta2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommitMeta2)

	if err != nil {
		return err
	}

	*o = CommitMeta2(varCommitMeta2)

	return err
}

type NullableCommitMeta2 struct {
	value *CommitMeta2
	isSet bool
}

func (v NullableCommitMeta2) Get() *CommitMeta2 {
	return v.value
}

func (v *NullableCommitMeta2) Set(val *CommitMeta2) {
	v.value = val
	v.isSet = true
}

func (v NullableCommitMeta2) IsSet() bool {
	return v.isSet
}

func (v *NullableCommitMeta2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommitMeta2(val *CommitMeta2) *NullableCommitMeta2 {
	return &NullableCommitMeta2{value: val, isSet: true}
}

func (v NullableCommitMeta2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommitMeta2) UnmarshalJSON(src []byte) error {
	v.isSet = true
