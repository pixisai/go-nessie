...
// checks if the ContentAnyOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentAnyOf1{}

// ContentAnyOf1 struct for ContentAnyOf1
type ContentAnyOf1 struct {
...
type _ContentAnyOf1 ContentAnyOf1
...
func (o ContentAnyOf1) MarshalJSON() ([]byte, error) {
...
func (o ContentAnyOf1) ToMap() (map[string]interface{}, error) {
...
func (o *ContentAnyOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varContentAnyOf1 := _ContentAnyOf1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContentAnyOf1)

	if err != nil {
		return err
	}

	*o = ContentAnyOf1(varContentAnyOf1)

	return err
}

type NullableContentAnyOf1 struct {
	value *ContentAnyOf1
	isSet bool
}

func (v NullableContentAnyOf1) Get() *ContentAnyOf1 {
	return v.value
}

func (v *NullableContentAnyOf1) Set(val *ContentAnyOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableContentAnyOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableContentAnyOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentAnyOf1(val *ContentAnyOf1) *NullableContentAnyOf1 {
	return &NullableContentAnyOf1{value: val, isSet: true}
}

func (v NullableContentAnyOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentAnyOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
