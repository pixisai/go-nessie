...
// checks if the Branch1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Branch1{}

// Branch1 struct for Branch1
type Branch1 struct {
...
func (o Branch1) MarshalJSON() ([]byte, error) {
...
func (o Branch1) ToMap() (map[string]interface{}, error) {
...
func (o *Branch1) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varBranch1)

	if err != nil {
		return err
	}

	*o = Branch1(varBranch1)

	return err
}

type NullableBranch1 struct {
	value *Branch1
	isSet bool
}

func (v NullableBranch1) Get() *Branch1 {
	return v.value
}

func (v *NullableBranch1) Set(val *Branch1) {
	v.value = val
	v.isSet = true
}

func (v NullableBranch1) IsSet() bool {
	return v.isSet
}

func (v *NullableBranch1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranch1(val *Branch1) *NullableBranch1 {
	return &NullableBranch1{value: val, isSet: true}
}

func (v NullableBranch1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranch1) UnmarshalJSON(src []byte) error {
	v.isSet = true
