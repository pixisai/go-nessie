...
// checks if the Content1AnyOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Content1AnyOf3{}

// Content1AnyOf3 struct for Content1AnyOf3
type Content1AnyOf3 struct {
...
type _Content1AnyOf3 Content1AnyOf3
...
func (o Content1AnyOf3) MarshalJSON() ([]byte, error) {
...
func (o Content1AnyOf3) ToMap() (map[string]interface{}, error) {
...
func (o *Content1AnyOf3) UnmarshalJSON(data []byte) (err error) {
	...
	varContent1AnyOf3 := _Content1AnyOf3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContent1AnyOf3)

	if err != nil {
		return err
	}

	*o = Content1AnyOf3(varContent1AnyOf3)

	return err
}

type NullableContent1AnyOf3 struct {
	value *Content1AnyOf3
	isSet bool
}

func (v NullableContent1AnyOf3) Get() *Content1AnyOf3 {
	return v.value
}

func (v *NullableContent1AnyOf3) Set(val *Content1AnyOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableContent1AnyOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableContent1AnyOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContent1AnyOf3(val *Content1AnyOf3) *NullableContent1AnyOf3 {
	return &NullableContent1AnyOf3{value: val, isSet: true}
}

func (v NullableContent1AnyOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContent1AnyOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
