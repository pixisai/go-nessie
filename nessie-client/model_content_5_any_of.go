...
// checks if the Content5AnyOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Content5AnyOf{}

// Content5AnyOf struct for Content5AnyOf
type Content5AnyOf struct {
...
type _Content5AnyOf Content5AnyOf
...
func (o Content5AnyOf) MarshalJSON() ([]byte, error) {
...
func (o Content5AnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *Content5AnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	varContent5AnyOf := _Content5AnyOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContent5AnyOf)

	if err != nil {
		return err
	}

	*o = Content5AnyOf(varContent5AnyOf)

	return err
}

type NullableContent5AnyOf struct {
	value *Content5AnyOf
	isSet bool
}

func (v NullableContent5AnyOf) Get() *Content5AnyOf {
	return v.value
}

func (v *NullableContent5AnyOf) Set(val *Content5AnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableContent5AnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableContent5AnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContent5AnyOf(val *Content5AnyOf) *NullableContent5AnyOf {
	return &NullableContent5AnyOf{value: val, isSet: true}
}

func (v NullableContent5AnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContent5AnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
